...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: DishInfoWidget.routeName,
          path: DishInfoWidget.routePath,
          builder: (context, params) => DishInfoWidget(
            dish: params.getParam(
              'dish',
        ...
        FFRoute(
          name: PoliWidget.routeName,
          path: PoliWidget.routePath,
          builder: (context, params) => PoliWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          asyncParams: {
            'dish': getDoc(
                ['AddedDishHistory'], AddedDishHistoryRecord.fromSnapshot),
          },
        ...
        FFRoute(
          name: RoastReloadPackWidget.routeName,
          path: RoastReloadPackWidget.routePath,
          builder: (context, params) => RoastReloadPackWidget(),
        ),
        FFRoute(
          name: DishAddAIWidget.routeName,
          path: DishAddAIWidget.routePath,
          builder: (context, params) => DishAddAIWidget(),
        )
